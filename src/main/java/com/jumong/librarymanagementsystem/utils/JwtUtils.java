package com.jumong.librarymanagementsystem.utils;
...
import com.jumong.librarymanagementsystem.exceptions.UnauthorizedException;
import jakarta.servlet.http.HttpServletRequest;

import java.util.Map;

import static com.jumong.librarymanagementsystem.exceptions.ExceptionMessage.INVALID_AUTHORIZATION_HEADER_EXCEPTION;
import static com.jumong.librarymanagementsystem.exceptions.ExceptionMessage.VERIFICATION_FAILED_EXCEPTION;
...
public class JwtUtils {
    ...
    public static String generateAccessToken(Long id){
        return JWT.create()
                ...
                .withIssuer("Library_Management_System")
